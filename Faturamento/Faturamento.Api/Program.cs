...
using Faturamento.Api.Consumers;
...
builder.Services.AddScoped<IValidator<AdicionarItemNotaFiscalRequest>, AdicionarItemNotaFiscalRequestValidator>();
builder.Services.AddScoped<IValidator<AtualizarItemNotaFiscalRequest>, AtualizarItemNotaFiscalRequestValidator>();
...
builder.Services.AddHostedService<EstoqueBaixaSucessoConsumer>();
builder.Services.AddHostedService<EstoqueBaixaFalhaConsumer>();
